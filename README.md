...
```
Install the "Exa Search" skill from Claw0x
```

Or use this connection prompt:

```
Add skill: exa-search
Platform: Claw0x
...
- [Skill Documentation](https://claw0x.com/skills/exa-search)
